...
def show_shopping_cart():
    ...
    for melon, qty in cart_dictionary.items():
        melon_object = melons.get_by_id(melon)
        melon_cost = (melon_object.price * qty)
        total_cost += melon_cost
        melon_object.qty = qty
        melon_object.cost = melon_cost
        melons_in_cart.append(melon_object)

    return render_template("cart.html", total=total_cost,
                           melons_list=melons_in_cart)
